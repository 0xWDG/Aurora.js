        ...
        while (len--) 
        {
    		...
    		for (var i = 0; i < parse.length; i++)
    		{
    			...
    			else if (parse[i].substr(0,4) == "    ") //Code
    			{
    				if (!codeOpen)
    				{
    					mrk += "<div style='display: block;padding: 9.5px;margin: 0 0 10px;font-size: 13px;line-height: 20px;word-break: break-all;word-wrap: break-word;white-space: pre;white-space: pre-wrap;background-color: #f5f5f5;border: 1px solid #ccc;border: 1px solid rgba(0, 0, 0, 0.15);-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;'><pre>";
    					codeOpen = true;
    				}
