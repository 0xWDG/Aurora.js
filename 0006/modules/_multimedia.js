...
else
{
    ...
    while (len--)
    {
      ...
      { 
        ...
        for (var i=0; i<data['file'].length; i++) 
        {
          ...
          // Main file
          // Create "MMElement" (MultiMediaElement)
          var MMElement = document.createElement(mediaType[data['file'][i].substr(data['file'][i].indexOf('.')+1)]);
   ...
   */
  _.fn.multimedia_start = function ( ) 
  {
   ...
   */
  _.fn.multimedia_pause = function ( ) 
  {
    // Start current player
